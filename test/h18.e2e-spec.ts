...
describe('e2e tests', () => {
  ...
  describe(
    'PUT -> "/blogger/users/:id/ban": should unban user by blogger for specified blog;' +
    ...
    () => {
      ...
      it(
        'Should get one banned user for blog1 and shouldn`t get unbanned user for blog2,' +
  ...
  describe(
    'PUT -> "/sa/blogs/:id/ban": should ban blog; status 204; used additional methods:' +
  ...
  describe(
    'GET -> "blogger/blogs": should return blogs created by blogger. Shouldn\'t return' +
  ...
  describe(
    'GET -> "/posts/:id": Shouldn\'t return banned blog post. Should return unbanned blog' +
    ...
    () => {
      ...
      it('Shouldn`t return post if owned blog was banned', async () => {
        ...
        await request(server).get(`/posts/${post0.id}`).expect(404);
      });
      ...
      it('Shouldn`t return post if owned blog was banned', async () => {
        ...
        await request(server).get(`/posts/${post0.id}`).expect(200);
      });
    },
  );
});
